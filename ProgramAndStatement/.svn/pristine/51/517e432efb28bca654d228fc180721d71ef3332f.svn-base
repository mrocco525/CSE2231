...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        Map<String, Statement> temporary = this.newContext();
        temporary.transferFrom(c);
        c.transferFrom(this.context);
        this.context.transferFrom(temporary);
    }
    ...
    public final void swapBody(Statement b) {
        ...
        Statement temporary = b.newInstance();
        temporary.transferFrom(b);
        b.transferFrom(this.body);
        this.body.transferFrom(temporary);
    }
