 ...
 * </pre>
 *
 * @author Mason Rocco, Caden Sweeney
 *
 */
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node originalRightFront = this.lastLeft.next;
        Node newRightFront = new Node();
        this.lastLeft.next = newRightFront;
        newRightFront.previous = this.lastLeft;
        newRightFront.data = x;
        newRightFront.next = originalRightFront;
        originalRightFront.previous = newRightFront;
        this.rightLength++;
    ...
    public final void advance() {
        ...
        Node originalLastLeft = this.lastLeft;
        this.lastLeft = originalLastLeft.next;
        this.rightLength--;
        this.leftLength++;
